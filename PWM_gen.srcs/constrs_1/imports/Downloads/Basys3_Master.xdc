...
# Switches
set_property PACKAGE_PIN V17 [get_ports {dut_cyc_0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dut_cyc_0}]
set_property PACKAGE_PIN V16 [get_ports {dut_cyc_1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dut_cyc_1}]
set_property PACKAGE_PIN W16 [get_ports {dut_cyc_no}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dut_cyc_no}]
